 ...
 */
FILE* file_open_with_fallback(const char* path, const char* mode) {
...
int setup_callbacks(void) {
    int thid = sceKernelCreateThread("callback_thread", callback_thread, CALLBACK_PRIO, CALLBACK_STACK, 0, 0);
    if(thid >= 0)
...
int main(void) {
    int callback_thid = setup_callbacks();
