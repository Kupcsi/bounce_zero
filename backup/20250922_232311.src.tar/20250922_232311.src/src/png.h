...
typedef enum {
    ...
    PNG_XFORM_ROT_270_FLIP_X,    // ROT_270 + FLIP_X (для Java tileImages[35])
    PNG_XFORM_ROT_270_FLIP_Y,    // ROT_270 + FLIP_Y (для Java tileImages[34])
    PNG_XFORM_ROT_270_FLIP_XY    // ROT_270 + FLIP_X + FLIP_Y
} png_xform_t;
